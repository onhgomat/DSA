<h2><a href="https://leetcode.com/problems/minimum-time-to-reach-target-with-limited-power">Minimum Time to Reach Target With Limited Power</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given a <strong>directed</strong> weighted graph with <code>n</code> nodes labeled from 0 to <code>n - 1</code>.</p>
